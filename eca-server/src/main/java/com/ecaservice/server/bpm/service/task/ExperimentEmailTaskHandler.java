...
public class ExperimentEmailTaskHandler extends AbstractTaskHandler {
    ...
    public void handle(DelegateExecution execution) {
        log.info("Starting to process experiment process [{}] email task", execution.getProcessBusinessKey());
        ...
        log.info("Experiment process [{}] email task has been processed", execution.getProcessBusinessKey());
    }
}
