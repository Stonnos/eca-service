...
class ClassifierOptionsRequestControllerTest extends PageRequestControllerTest {
    ...
    void testGetClassifierOptionsRequestsOk() throws Exception {
        ...
        var pageDto = PageDto.of(classifierOptionsRequestDtoList, PAGE_NUMBER, TOTAL_ELEMENTS);
        when(classifierOptionsRequestService.getClassifierOptionsRequestsPage(any(PageRequestDto.class))).thenReturn(
                pageDto);
