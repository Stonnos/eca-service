...
class ErsServiceTest extends AbstractJpaTest {
    ...
    void testGetExperimentResultsDetailsWithResultsNotFoundStatus() {
        var badRequestEx = new ErsBadRequestException(ErsErrorCode.RESULTS_NOT_FOUND, StringUtils.EMPTY);
    ...
    void testGetExperimentResultsDetailsWithServiceUnavailable() {
        InternalServiceUnavailableException serviceUnavailable = new InternalServiceUnavailableException(StringUtils.EMPTY);
