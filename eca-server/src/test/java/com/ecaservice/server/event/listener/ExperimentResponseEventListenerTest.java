...
class ExperimentResponseEventListenerTest {
    ...
    void init() {
        ...
        experimentResponseEventListener =
                new ExperimentResponseEventListener(experimentConfig, amqpAdmin, rabbitTemplate, ecaResponseMapper);
    }
    ...
    void testHandleExperimentResponse() {
        ...
        String expectedDownloadUrl = buildExperimentDownloadUrl(BASE_URL, experiment.getToken());
        assertThat(actualResponse.getDownloadUrl()).isEqualTo(expectedDownloadUrl);
    }
}
