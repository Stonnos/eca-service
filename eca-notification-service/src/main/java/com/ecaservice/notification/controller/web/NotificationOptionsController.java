package com.ecaservice.notification.controller.web;

import com.ecaservice.common.error.model.ValidationErrorDto;
import com.ecaservice.notification.dto.UpdateUserNotificationOptionsDto;
import com.ecaservice.notification.service.NotificationOptionsService;
...
/**
 * Implements notification options REST API.
 *
 * @author Roman Batygin
 */
@Slf4j
@Validated
@Tag(name = "Notification options API for web application")
@RestController
@RequestMapping("/notification/options")
@RequiredArgsConstructor
public class NotificationOptionsController {

    private final NotificationOptionsService notificationOptionsService;
    ...
    public UserProfileNotificationOptionsDto getUserNotificationOptions(Principal principal) {
        ...
        return notificationOptionsService.getUserNotificationOptions(principal.getName());
    }
    ...
    public void updateUserNotificationOptions(Principal principal,
        ...
        notificationOptionsService.updateUserNotificationOptions(principal.getName(), updateUserNotificationOptionsDto);
