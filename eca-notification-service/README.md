Модуль eca-notification-service
========================================
...
2. API для отправки web - пушей с помощью web - сокетов.
3. API для отправки email.
4. API для настройки уведомлений в профиле пользователя.
...
* Openjdk 21
* maven => 3.9.2
* База данных PostgreSQL 17.6 для хранения информации.
...
2. Запустить проект с помощью команды:
    ...
    java -jar /target/eca-notification-service.jar
