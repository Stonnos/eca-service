...
import com.ecaservice.web.push.service.EmailService;
...
@Validated
@Component
@ConditionalOnProperty(value = "mail.rabbit.enabled", havingValue = "true")
...
public class EmailEventListener {
     ...
     */
    @RabbitListener(queues = "${mail.rabbit.queueName}")
