...
|deleted_model_after        |timestamp        |-|-|-                                    |Дата следующей попытки удаления модели классификатора
...
|deleted_model_after          |timestamp        |-|-|-                                 |Дата следующей попытки удаления модели эксперимента
