...
==== Таблица 3.{counter:db-table-id} - 'classifier_input_options' - содержит данные о входных параметрах классификатора
[cols="^20%,^14%,^8%,^8%,^8%,^30%",options="header"]
|===
|Название колонки|Тип|Unique|Not NULL|Индекс|Описание
|id                      |bigint           |+|+|+                                               |Идентификатор записи (первичный ключ)
...
|experiment_path              |varchar(255)     |-|-|-                                 |Путь к объекту в S3 с результатами эксперимента
|error_message                |text             |-|-|-                                 |Текст ошибки
...
|authentication          |bytea            |-|-|-                                          |Сериализованный объект Authentication
...
==== Таблица 3.{counter:db-table-id} - 'input_options' - содержит данные о входных параметрах классификаторов
[cols="^20%,^14%,^8%,^8%,^8%,^30%",options="header"]
|===
|Название колонки|Тип|Unique|Not NULL|Индекс|Описание
...
На рисунке 3.4 приведена схема базы данных eca-web-push:
...
|token_id                |varchar(255)      |-|+|push_token_token_id_unique_idx  |Токен
...
|Название колонки|Тип|Unique|Not NULL|Индекс|Описание
|id                      |bigint            |+|+|+                                                    |Идентификатор записи (первичный ключ)
|parameter_name          |varchar(255)      |+|+|notification_parameter_id_parameter_name_unique_idx  |Название параметра
|parameter_value         |varchar(255)      |-|+|notification_parameter_id_parameter_name_unique_idx  |Значение параметра
|===
