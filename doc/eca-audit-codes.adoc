...
|USER_PROFILE_ACTIONS
|REVOKE_CHANGE_EMAIL_REQUEST
|Отмена запроса на изменение Email
|USER_PROFILE_ACTIONS
|LOGIN
|Вход в систему
|USER_PROFILE_ACTIONS
...
|Создание токена доступа (personal access token)
|USER_PROFILE_ACTIONS
|DELETE_PERSONAL_ACCESS_TOKEN
|Удаление токена доступа (personal access token)
|USER_PROFILE_ACTIONS
|FORCE_SET_PASSWORD
...
|Выгрузка отчета с результатами классификации для модели
|EVALUATION_REQUESTS_ACTIONS
|GENERATE_EXPERIMENT_RESULTS_REPORT
|Выгрузка отчета с результатами классификации для данных эксперимента
|EVALUATION_REQUESTS_ACTIONS
