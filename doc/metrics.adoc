...
|*core_lock_success_total{application="eca-server",lockName="saveEmail",}*
|Счетчик числа успешных блокировок saveEmail (сохранение запроса на отправку email)
a|`core_lock_success_total{application="eca-server",lockName="saveEmail",} 2.0`
|*core_unlock_success_total{application="eca-server",lockName="saveEmail",}*
|Счетчик числа успешных операций снятия блокировок saveEmail
a|`core_unlock_success_total{application="eca-server",lockName="saveEmail",} 2.0`
|*core_lock_acquire_error_total{application="eca-server",lockName="saveEmail",}*
|Счетчик числа ошибок при получении блокировки saveEmail
a|`core_lock_acquire_error_total{application="eca-server",lockName="saveEmail",} 2.0`
|*core_unlock_error_total{application="eca-server",lockName="saveEmail",}*
|Счетчик числа ошибок при попытке снять блокировку saveEmail
a|`core_unlock_error_total{application="eca-server",lockName="saveEmail",} 2.0`
|*core_lock_success_total{application="eca-server",lockName="saveEvaluationResults",}*
|Счетчик числа успешных блокировок saveEvaluationResults (сохранение результатов классификации в ERS)
a|`core_lock_success_total{application="eca-server",lockName="saveEvaluationResults",} 2.0`
|*core_unlock_success_total{application="eca-server",lockName="saveEvaluationResults",}*
|Счетчик числа успешных операций снятия блокировок saveEvaluationResults
a|`core_unlock_success_total{application="eca-server",lockName="saveEvaluationResults",} 2.0`
|*core_lock_acquire_error_total{application="eca-server",lockName="saveEvaluationResults",}*
|Счетчик числа ошибок при получении блокировки saveEvaluationResults
a|`core_lock_acquire_error_total{application="eca-server",lockName="saveEvaluationResults",} 2.0`
|*core_unlock_error_total{application="eca-server",lockName="saveEvaluationResults",}*
|Счетчик числа ошибок при попытке снять блокировку saveEvaluationResults
a|`core_unlock_error_total{application="eca-server",lockName="saveEvaluationResults",} 2.0`
|*core_lock_success_total{application="eca-server",lockName="saveAuditEvent",}*
|Счетчик числа успешных блокировок saveAuditEvent (сохранение события аудита)
a|`core_lock_success_total{application="eca-server",lockName="saveAuditEvent",} 2.0`
|*core_unlock_success_total{application="eca-server",lockName="saveAuditEvent",}*
|Счетчик числа успешных операций снятия блокировок saveAuditEvent
a|`core_unlock_success_total{application="eca-server",lockName="saveAuditEvent",} 2.0`
|*core_lock_acquire_error_total{application="eca-server",lockName="saveAuditEvent",}*
|Счетчик числа ошибок при получении блокировки saveAuditEvent
a|`core_lock_acquire_error_total{application="eca-server",lockName="saveAuditEvent",} 2.0`
|*core_unlock_error_total{application="eca-server",lockName="saveAuditEvent",}*
|Счетчик числа ошибок при попытке снять блокировку saveAuditEvent
a|`core_unlock_error_total{application="eca-server",lockName="saveAuditEvent",} 2.0`
|*core_lock_success_total{application="eca-server",lockName="getOrSaveErsInstancesInfo",}*
|Счетчик числа успешных блокировок getOrSaveErsInstancesInfo (сохранение обучающей выборки в ERS)
a|`core_lock_success_total{application="eca-server",lockName="getOrSaveErsInstancesInfo",} 2.0`
|*core_unlock_success_total{application="eca-server",lockName="getOrSaveErsInstancesInfo",}*
|Счетчик числа успешных операций снятия блокировок getOrSaveErsInstancesInfo
a|`core_unlock_success_total{application="eca-server",lockName="getOrSaveErsInstancesInfo",} 2.0`
|*core_lock_acquire_error_total{application="eca-server",lockName="getOrSaveErsInstancesInfo",}*
|Счетчик числа ошибок при получении блокировки getOrSaveErsInstancesInfo
a|`core_lock_acquire_error_total{application="eca-server",lockName="getOrSaveErsInstancesInfo",} 2.0`
|*core_unlock_error_total{application="eca-server",lockName="getOrSaveErsInstancesInfo",}*
