...
a|
`tomcat_sessions_active_current_sessions{application="eca-notification-service",} 0.0`

`jvm_buffer_memory_used_bytes{application="eca-notification-service",id="direct",} 8192.0`

`jvm_buffer_memory_used_bytes{application="eca-notification-service",id="mapped",} 0.0`

`jvm_memory_max_bytes{application="eca-notification-service",area="heap",id="G1 Survivor Space",} -1.0`

`jvm_memory_max_bytes{application="eca-notification-service",area="heap",id="G1 Old Gen",} 4.158652416E9`
...
a|`eca_mail_sending_message_success_total{application="eca-notification-service",} 0.0`
|*eca_mail_sending_message_error_total*
|Счетчик числа ошибок при отправке email сообщений
a|`eca_mail_sending_message_error_total{application="eca-notification-service",} 0.0`
...
|*core_lock_success_total{application="eca-notification-service",lockName="saveEmail",}*
|Счетчик числа успешных блокировок saveEmail (сохранение запроса на отправку email)
a|`core_lock_success_total{application="eca-notification-service",lockName="saveEmail",} 2.0`
|*core_unlock_success_total{application="eca-notification-service",lockName="saveEmail",}*
|Счетчик числа успешных операций снятия блокировок saveEmail
a|`core_unlock_success_total{application="eca-notification-service",lockName="saveEmail",} 2.0`
|*core_lock_acquire_error_total{application="eca-notification-service",lockName="saveEmail",}*
|Счетчик числа ошибок при получении блокировки saveEmail
a|`core_lock_acquire_error_total{application="eca-notification-service",lockName="saveEmail",} 2.0`
|*core_unlock_error_total{application="eca-notification-service",lockName="saveEmail",}*
|Счетчик числа ошибок при попытке снять блокировку saveEmail
a|`core_unlock_error_total{application="eca-notification-service",lockName="saveEmail",} 2.0`
...
|*core_retry_request_cache_size_total{application="appName",request_type="webPushRequest",}*
|Счетчик числа запросов, которые были сохранены в кэш для повторной отправки в web push сервис (для application: eca-server)
a|`core_retry_request_cache_size_total{application="appName",request_type="webPushRequest",} 1.0`
|*core_retry_request_error_total{application="appName",request_type="webPushRequest",}*
|Счетчик числа ошибок для запросов, которые не были сохранены в кэш для повторной отправки в web push сервис (для application: eca-server)
a|`core_retry_request_error_total{application="appName",request_type="webPushRequest",} 0.0`
|*core_retries_failed_total{application="appName",request_type="webPushRequest",}*
|Счетчик числа неуспешных попыток повторной отправки запросов в web push сервис (для application: eca-server)
a|`core_retries_failed_total{application="appName",request_type="webPushRequest",} 3.0`
|*core_retries_success_total{application="appName",request_type="webPushRequest",}*
|Счетчик числа успешных попыток повторной отправки запросов в  web push сервис (для application: eca-server)
a|`core_retries_success_total{application="appName",request_type="webPushRequest",} 1.0`
|*core_retries_exhausted_total{application="appName",request_type="webPushRequest",}*
|Счетчик числа превышений лимита попыток для повторной отправки запросов в  web push сервис (для application: eca-server)
a|`core_retries_exhausted_total{application="appName",request_type="webPushRequest",} 0.0`
|*core_retries_error_total{application="appName",request_type="webPushRequest",}*
|Счетчик числа критических ошибок при повторной отправки запросов в web push сервис (для application: eca-server)
a|`core_retries_error_total{application="appName",request_type="webPushRequest",} 0.0`
...
|*eca_server_evaluation_mq_request_error_total*
|Счетчик ошибок обработки сообщений для построения моделей
a|
`eca_server_evaluation_mq_request_error_total{error="INTERNAL_SERVER_ERROR"}`
|*eca_server_evaluation_request_status_total*
|Счетчик обработанных заявок на построение моделей классификаторов, параметризированный по статусу (status)
a|
`eca_server_evaluation_request_status_total{application="eca-server",status="ERROR"}`
`eca_server_evaluation_request_status_total{application="eca-server",status="SUCCESS"}`
`eca_server_evaluation_request_status_total{application="eca-server",status="TIMEOUT"}`
|*eca_server_experiment_request_status_total*
|Счетчик обработанных заявок на построение эксперимента, параметризированный по статусу (status)
a|
`eca_server_experiment_request_status_total{application="eca-server",status="ERROR"}`
`eca_server_experiment_request_status_total{application="eca-server",status="SUCCESS"}`
`eca_server_experiment_request_status_total{application="eca-server",status="TIMEOUT"}`
|*eca_server_evaluation_request_total*
|Счетчик заявок на построение моделей классификаторов
a|
`eca_server_evaluation_request_total{application="eca-server",error="INTERNAL_SERVER_ERROR"}`
|*eca_server_experiment_request_total*
|Счетчик заявок на построение эксперимента
a|
`eca_server_experiment_request_total{application="eca-server",error="INTERNAL_SERVER_ERROR"}`
|===
...
a|
`feign_Client_seconds_max{application="eca-server",client="com.ecaservice.server.service.experiment.mail.EmailClient",host="eca-notification-service",method="sendEmail",} 0.0`
