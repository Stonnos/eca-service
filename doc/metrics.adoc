...
|Получение всех метрик приложения в формате для prometheus
a|
...
|Получение информации о версии, сборке, коммите и т.д.
a|
[source,json]
----
{
  "git": {
    ...
    "commit": {
      ...
      "user": {
        "name": "Батыгин Роман Игоревич",
        "email": "batygin@self.team"
      },
