...
__POST__ */instances/contingency-table-report* - Calculates contingency table report
...
----
{
  "tableData" : [ [ 67, 160, 12, 13, 22, 274 ], [ 55, 146, 35, 18, 15, 269 ], [ 153, 187, 38, 7, 9, 394 ], [ 18, 37, 3, 2, 3, 63 ], [ 293, 530, 88, 40, 49, 1000 ] ],
  "chiSquaredValue" : 60.3321,
  "chiSquaredCriticalValue" : 21.0261,
  "df" : 12,
  "alpha" : 0.05,
  "significant" : true,
  "xattribute" : {
  ...
  "yattribute" : {
    ...
    "values" : [ {
      ...
      "id" : 7,
      "index" : 2,
      "value" : "delayed previously"
    }, {
      "id" : 8,
      "index" : 3,
      "value" : "no credits/all paid"
    }, {
      "id" : 9,
      "index" : 4,
      "value" : "all paid"
...
__GET__ */instances/route-path/{externalDataUuid}* - Gets instances path by external data uuid from central storage
...
----
{
  "path" : "/dashboard/instances/details/394"
}
----
|401
|Not authorized
...
__GET__ */instances/attributes-scatter-plot* - Gets scatter plot data
...
=== ContingencyTableRequestDto
:table-caption: Table
.Attributes contingency table request model
[width=100%]
|===
|*Name*|*Description*|*Schema*
|*instancesId**
