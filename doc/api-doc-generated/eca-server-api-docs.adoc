...
__POST__ */experiment/upload-experiment-results-attachment* - Uploads experiment results attachment
...
__POST__ */evaluation/upload-evaluation-results-attachment* - Uploads evaluation results attachment
...
__GET__ */instances-info/download/{instancesId}* 
...
__GET__ */instances-info/details/{instancesId}* 
...
__GET__ */experiment/results/report/{experimentResultsId}* - Downloads experiment results report in xlsx format
...
__GET__ */evaluation/results/report/{id}* - Downloads evaluation results report in xlsx format
