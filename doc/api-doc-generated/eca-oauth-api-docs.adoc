...
__POST__ */personal-access-token/list* - Gets current user personal access tokens next page for specified page request
...
----
{
  "content" : [ {
    "id" : 1,
    "name" : "Token",
    "expireDate" : "2026-07-01 14:00:00",
    "valid" : true
  } ],
  "page" : 0,
  "totalCount" : 1
...
__POST__ */personal-access-token/create* - Creates personal access token for user
...
----
{
  ...
  "expireDate" : "2026-07-01 14:00:00",
  "valid" : true,
  "token" : "6Igz-7_3QGSioGgoFxSe_N_ByhCq1IuQaKJ2i_GBw5TZT_SVtfK44DThXfZ8jj0eXOHazAx23MwfUVpNkX-d2GVdguKlOPEJgXx_xfYAJ-8zOiUiar7H3b39w4RCKrdF"
}
----
|401
|Not authorized
...
----
[ {
  "code" : "DuplicatePersonalAccessTokenName",
  "errorMessage" : "Duplicate personal access token name"
} ]
----
|===
...
----
{
  "menuItems" : [ {
    ...
    "label" : "История результатов классификации",
    "routerLink" : "/dashboard/evaluation-results-history",
    "icon" : "pi pi-list",
    "styleClass" : null,
    "items" : null
  }, {
    ...
    "items" : [ {
      ...
      "styleClass" : null,
      "items" : [ {
        "label" : "Конфигурации классификаторов",
        "routerLink" : "/dashboard/experiments/classifiers-configurations",
        "icon" : null,
        "styleClass" : "classifiers-configurations-menu-item",
        "items" : null
      } ]
    } ]
  } ]
...
__GET__ */api/internal/personal-access-token/verify-token* - Verify personal access token
...
__DELETE__ */personal-access-token/remove/{id}* - Removes user personal access token
...
=== PersonalAccessTokensPageDto
:table-caption: Table
.UPersonal access token page dto
[width=100%]
|===
|*Name*|*Description*|*Schema*
|*content*
