...
== Evaluation results storage internal API
...
a|
link:./examples/eca-ers/EvaluationRequest.json[EvaluationRequest.json]
|===
...
a|
link:./examples/eca-ers/GetEvaluationResultsResponse.json[GetEvaluationResultsResponse.json]
|400
|Bad request
|*application/json*
|
...
----
|===
== Evaluation results history API for web application
...
a|
link:./examples/eca-ers/EvaluationResultsHistoryPageResponse.json[EvaluationResultsHistoryPageResponse.json]
|401
|Not authorized
|*application/json*
|-
...
|-
a|
link:./examples/eca-ers/EvaluationResultsHistoryFilterFieldsResponse.json[EvaluationResultsHistoryFilterFieldsResponse.json]
|401
|Not authorized
|*application/json*
|-
