...
a|
link:./examples/eca-ers/EvaluationRequest.json[Show]
|===
...
a|
link:./examples/eca-ers/GetEvaluationResultsResponse.json[Show]
|400
|Bad request
|*application/json*
|
...
a|
link:./examples/eca-ers/EvaluationResultsHistoryPageResponse.json[Show]
|401
|Not authorized
|*application/json*
|-
...
|-
a|
link:./examples/eca-ers/EvaluationResultsHistoryFilterFieldsResponse.json[Show]
|401
|Not authorized
|*application/json*
|-
