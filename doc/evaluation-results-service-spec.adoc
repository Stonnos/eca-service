...
[source,bash]
----
curl client:secret@eca-service:8080/eca-oauth/oauth2/token -d grant_type=client_credentials
----
...
== 3. Описание формата отправки результатов классификации

=== 3.1. Структура запроса отправки результатов классификации
...
=== 3.2. Описание полей запроса отправки результатов классификации

==== 3.2.1. Описание полей блока EvaluationResultsRequest
...
==== 3.2.2. Описание полей блока InstancesReport
...
==== 3.2.3. Описание полей блока ClassifierReport
...
==== 3.2.4. Описание полей блока EvaluationMethodReport
...
==== 3.2.5. Описание полей блока StatisticsReport
...
==== 3.2.6. Описание полей блока ClassificationCostsReport
...
==== 3.2.7. Описание полей блока RocCurveReport
...
==== 3.2.8. Описание полей блока ConfusionMatrixReport
...
== 4. Описание формата ответа на запрос о сохранении результатов классификации

=== 4.1. Структура ответа на запрос о сохранении результатов классификации
...
=== 4.2. Описание полей ответа на запрос о сохранении результатов классификации
...
== 5. Описание формата запроса на нахождение оптимальных конфигураций классификаторов

=== 5.1. Структура запроса на нахождение оптимальных конфигураций классификаторов
...
=== 5.2. Описание полей запроса на нахождение оптимальных конфигураций классификаторов
...
==== 5.2.1. Описание полей блока EvaluationResultsStatisticsSortField
...
== 6. Описание формата ответа на запрос о нахождении оптимальных конфигураций классификаторов

=== 6.1. Структура ответа на запрос о нахождении оптимальных конфигураций классификаторов
...
=== 6.2. Описание полей ответа на запрос о нахождении оптимальных конфигураций классификаторов
...
== 7. Описание формата запроса на получение результатов классификации

=== 7.1. Структура запроса на получение результатов классификации
...
=== 7.2. Описание полей запроса на получение результатов классификации
...
== 8. Описание формата ответа на запрос о получении результатов классификации

=== 8.1. Структура ответа на запрос о получении результатов классификации
...
=== 8.2. Описание полей ответа на запрос о получении результатов классификации
