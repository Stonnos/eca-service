...
|Заполняется по по справочнику <<Справочник значений EvaluationResultsStatisticsField>>. По умолчанию используется ASC.
|2
|direction
|SortDirection
|+
...
|Заполняется по по справочнику <<Справочник значений SortDirection>>.
|===
